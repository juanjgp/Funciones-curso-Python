...
def evolution_pokemon(my_pokemon, first_evolution, second_evolution):
    if my_pokemon["level"] == 2: # Si se llega al nivel adecuado, el pokémon experimenta su primera evolución.
    ...
    if my_pokemon["level"] == 4:  # Si se llega al nivel adecuado, el pokémon experimenta su segunda evolución
